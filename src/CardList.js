...
const Click = (a) => {
    ...
    if (selectFactor1 != 0 && selectFactor2 != '') {
        ...
        * 🖨 Печать и копирование:
        📄1-20 страниц - 5 руб/лист,
        📄21-40 страниц - 4 руб/лист,
        📄41+ страниц - 3 руб/лист.

        📇 Скан:
        📄1-5 страниц - 12 руб/лист,
        📄6-10 страниц - 10 руб/лист,
        ...
        * */
        ...
        if (service[0].id == 1 || service[0].id == 2) {
            ...
            if (pageCount >= 1 && pageCount <= 20) {
                ...
                pricedesc.innerHTML = '📄1-20 страниц - 5 руб/лист,\n' +
                    '        📄21-40 страниц - 4 руб/лист,\n' +
                    '        📄41+ страниц - 3 руб/лист.'
            }
